...
const salesDonutChart = {
  chartOptions: {
    ...
    labels: ['Nelore', 'Angus', 'Caracu', 'Outras'],
    responsive: [
      {
        breakpoint: 480,
        options: {
    ...
    tooltip: {
      y: {
        formatter: (value) => {
          return value + ' Cabeças'
        },
      },
    },
  },
  series: [224, 196, 128, 12],
}
...
const categoriaChart = {
  chartOptions: {
    ...
    labels: ['Vitelo', 'Novilho', 'Boi', 'Outras'],
    responsive: [
      {
        breakpoint: 480,
        options: {
...
export { revenueAreaChart, targetsBarChart, salesDonutChart, ordersData, sexoChart, categoriaChart }
