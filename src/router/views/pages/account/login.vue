...
export default {
    page: {
        ...
        meta: [{
            name: 'description',
            content: `Log in to ${appConfig.title}`
        }],
    },
    components: {
        Layout
    ...
    methods: {
        ...
        tryToLogIn() {
			...
			if(this.username=='junin'){
				this.authError = 'Usuário bloqueado'
            ...
            return this.logIn({
                ...
                .catch((error) => {
                    this.tryingToLogIn = false
					if(error.response){
						this.authError = error.response.data.message == 'Invalid user credentials.' ? 'Credenciais de usuário inválidas' : error.response.data.message
					}
                                ...
                                <div class="col-md-6 p-5">
                                    <div class="mx-auto mb-5">
                                        <a routerLink="/">
                                            ...
                                            <h3 class="d-inline align-middle ml-1 text-logo ml-3">Gado de <span style="color: goldenrod;">Ouro</span></h3>
                                        </a>
                                    </div>
                                    ...
                                    <b-form class="authentication-form" @submit.prevent="tryToLogIn">
                                        <div class="form-group">
                                            <div class="input-group input-group-merge">
                                                ...
                                                <b-form-input id="input-1" v-model="username" type="text" required placeholder="Enter username"></b-form-input>
                                            </div>
                                        </div>
                                        <div class="form-group mt-4">
                                            <label class="form-control-label">Password</label>
                                            <router-link to="forget-password" class="float-right text-muted text-unline-dashed ml-1">Esqueceu sua senha?</router-link>
                                            <div class="input-group input-group-merge">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                ...
                                <div class="col-lg-6 d-none d-md-inline-block">
                                    <div class="auth-page-sidebar">
                                        ...
                                        <div class="auth-user-testimonial">
                                            <p class="font-size-24 font-weight-bold text-white mb-1">Gado de <span style="color: goldenrod;">Ouro</span></p>
                                            <p class="lead">Simplificando a Gestão de Rebanhos</p>
